...
td#col_2{ background:transparent;
opacity:0.8
}
td#col_3{ 
...
li { list-style:none;margin-left:0;}
	...
	<div id='body' style="width:85%;margin-left:auto;margin-right:auto;padding:10px 20px 10px 20px;border:4px solid #ddd;border-radius:10px;
...
$begin=$pg-5>0?$pg-5:0; $end=$pg+5; for($k=$begin;$k<$end;$k++){ ?>
	...
	<td id='col_2' bgcolor='#fafafa' style="width:50%;margin-top:-15px;position:absolute;display:block;"> <!--efffff-->
		<div>
			<ul><li>
				在线评测平台
				<table frame="hsides" width=100% style="table-layout:fixed;" >
