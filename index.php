...
<div id='col_1' bgcolor='fafafa' border=0>
...
<!-- 'f1e6d4' -->
<div id="col" style=""><!-- bgcolor='F1E6D4' -->  <!--'F1E6D4'-->
access
<ul><li>
...
function showLabel(s){
  ...
  <div id='col_2' bgcolor='#fafafa' style=""> <!--efffff-->
    <div id="col">
      <ul><li>
        在线评测平台
        <table frame="hsides" width=100% style="table-layout:fixed;" >
...
$begin=$pg-5>0?$pg-5:0; $end=$pg+5; for($k=$begin;$k<$end;$k++){ ?>
        <a href="javascript:void(0);" onclick="pull_reply(<?php echo $k ?>);" ><?php echo $k?></a>
          ...
          本站地图
        <table><tr>
        <td><a target="__blank" href="/down">down</a></td>
        <td><a target="__blank" href="/album">album</a></td>
        <td><a target="__blank" href="/push">push</a></td>
        <td><a target="__blank" href="/pic">picsearch</a></td>
      </tr></table>
      </li></ul>
    </div>
<!-- the end of file -->
